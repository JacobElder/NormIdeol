...
```{r}
longDf1 <- arrow::read_parquet("./output/PFfullDf.parquet")
distDf1 <- arrow::read_parquet("./output/distanceDf.parquet")
varDf1 <- arrow::read_parquet("./output/varDf1.parquet")
...
```{r}
longDf2 <- arrow::read_parquet("./output/PFfullDf2.csv")
distDf2 <- arrow::read_parquet("./output/distanceDf2.csv")
varDf2 <- arrow::read_parquet("./output/varDf2.csv")
