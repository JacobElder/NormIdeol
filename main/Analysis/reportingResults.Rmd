...
library(groundhog)
pkgs <-  c("corrr","tidyverse","ggplot2","lme4","lmerTest", "ggeffects", "sjPlot", "insight", "data.table")
groundhog.day <- '2022-07-25'
groundhog.library(pkgs, groundhog.day)
```

```{r}
id_long1 <- "1oGb9pcJp4b8Y5uwSgxrlgCaX9WYCMvOV" # google file ID
id_distDf1 <- "1QoCa1_FDU5CkAgU7bgpzPNWw7Vwz8uUj" # google file ID
id_varDf1 <- "1hSb4rsPgvUakASFuhjaMYLUI3P8d163X" # google file ID

longDf1 <- fread(sprintf("https://docs.google.com/uc?id=%s&export=download", id_long1))
distDf1 <- fread(sprintf("https://docs.google.com/uc?id=%s&export=download", id_distDf1))
varDf1 <- fread(sprintf("https://docs.google.com/uc?id=%s&export=download", id_varDf1))
...
# varDf1 <- fread("./output/varDf1.csv")
...
```
```{r}
id_long2 <- "1dnn4i4qB78PSi8pds-u8r4TXYG5E0hoh" # google file ID
id_distDf2 <- "19xlZuQqjFoI2J9I4PTceHHOrjW43Mj7z" # google file ID
id_varDf2 <- "1hMdFfq97mg4BLTgxDOQX4ytuVGFS5D-c" # google file ID

longDf2 <- fread(sprintf("https://docs.google.com/uc?id=%s&export=download", id_long2))
distDf2 <- fread(sprintf("https://docs.google.com/uc?id=%s&export=download", id_distDf2))
varDf2 <- fread(sprintf("https://docs.google.com/uc?id=%s&export=download", id_varDf2))

distDf2 <- read_csv(sprintf("https://docs.google.com/uc?id=%s&export=download", id_distDf2))
...
#varDf2 <- fread("./output/varDf2.csv")
