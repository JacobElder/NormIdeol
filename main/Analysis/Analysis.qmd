...
m_cons_in_affPol_1 <- lmer( scale(inDev) ~ scale(affPol) +  ( 1 | subID) + (1 | issues), data = longDf1, control=lmerControl(optimizer="bobyqa",
                                optCtrl=list(maxfun=2e5)))
summary(m_cons_out_affPol_1)
m_cons_in_affPol_1_CI  <- confint(m_cons_in_affPol_1, method= "Wald")
ggpredict(m_cons_out_affPol_1, c("affPol")) %>% plot()

m_cons_out_affPol_1 <- lmer( scale(outDev) ~ scale(affPol) + ( 1 | subID) + (1 | issues), data = longDf1, control=lmerControl(optimizer="bobyqa",
                                optCtrl=list(maxfun=2e5)))
summary(m_cons_out_affPol_1)
m_cons_out_affPol_1_CI  <- confint(m_cons_out_affPol_1, method= "Wald")
ggpredict(m_cons_out_affPol_1, c("affPol")) %>% plot()
```
...
```{r}
m_cons_in_affPol_2 <- lmer( scale(inDev) ~ scale(affPol) +  ( 1 | subID) + (1 | issues), data = longDf1, control=lmerControl(optimizer="bobyqa",
                                optCtrl=list(maxfun=2e5)))
summary(m_cons_out_affPol_2)
m_cons_in_affPol_2_CI  <- confint(m_cons_in_affPol_2, method= "Wald")
ggpredict(m_cons_out_affPol_2, c("affPol","ceiling")) %>% plot()

m_cons_out_affPol_2 <- lmer( scale(outDev) ~ scale(affPol) + ( 1 | subID) + (1 | issues), data = longDf1, control=lmerControl(optimizer="bobyqa",
                                optCtrl=list(maxfun=2e5)))
summary(m_cons_out_affPol_2)
m_cons_out_affPol_2_CI  <- confint(m_cons_out_affPol_2, method= "Wald")
ggpredict(m_cons_out_affPol_2, c("affPol")) %>% plot()
```
