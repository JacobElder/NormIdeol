...
Sim.AffPol.Comb
ggsave(paste0(plotswd,objectName(Sim.AffPol.Comb),".jpg"), width = 9, height = 6, dpi=300, units="in")
ggsave(paste0(plotswd,objectName(Sim.AffPol.Comb),".tiff"), width = 9, height = 6, dpi=300, units="in")
```

```{r}
Sim.Comb <- ggarrange(Sim.AffPol.Comb, Sim.Info.Comb, nrow = 2, ncol = 1)
Sim.Comb
ggsave(paste0(plotswd,objectName(Sim.Comb),".jpg"), width = 10, height = 9, dpi=300, units="in")
ggsave(paste0(plotswd,objectName(Sim.Comb),".tiff"), width = 10, height = 9, dpi=300, units="in")
```
